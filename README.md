...
output_path/
  ...
  delivery/
    frame_0001/
      ...
      film_1bit.tif
      film_1bit_lby_low_fp.tif
      film_1bit_lby_balanced.tif
      film_1bit_lby_more_black.tif
...
- 150 张 `2160 x 3651` JPG、`4000 PPI`、`PE=52.64`、反转视角顺序、同时输出 baseline 与三张 LBY 调参候选的 native 全流程本次实测生成时间约 `105.209s`。
